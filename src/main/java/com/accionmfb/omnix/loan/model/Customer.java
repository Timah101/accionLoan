...
public class Customer implements Serializable {
    ...
    @Column(name="guarantor_1_name")
    private String guarantor_1_name="";
    @Column(name="guarantor_2_name")
    private String guarantor_2_name="";
    @Column(name="guarantor_1_mobile")
    private String guarantor_1_mobile="";
    @Column(name="guarantor_2_mobile")
    private String guarantor_2_mobile="";
